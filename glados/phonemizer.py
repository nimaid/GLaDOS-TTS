...
@dataclass
class ModelConfig:
    MODEL_NAME: Path = Path(MODULE_DIR, "models/phomenizer_en.onnx")
    PHONEME_DICT_PATH: Path = Path(MODULE_DIR, "models/lang_phoneme_dict.pkl")
    TOKEN_TO_IDX_PATH: Path = Path(MODULE_DIR, "models/token_to_idx.pkl")
    IDX_TO_TOKEN_PATH: Path = Path(MODULE_DIR, "models/idx_to_token.pkl")
    CHAR_REPEATS: int = 3
